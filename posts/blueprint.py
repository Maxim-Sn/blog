...
from .forms import PostForm #точка означает что имопрт произойдет из текущей папки
from app import db
...
def main_index():
	...
	return render_template('index.html', q = temperature, t = (fc.get_weather_at(d).get_detailed_status()))